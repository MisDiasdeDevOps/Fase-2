...
- [✔️] ☁️ 25 > [-  Clase de Docker en profundidadDesafíos semanales - Utilizacion de Process Explorer Para Analisis de Malware - Sysinternals ](Days/day25.md)
- [✔️] ☁️ 26 > [-  Clase de Docker en profundidadDesafíos semanales - Comandos Utiles y Necesarios PowerShell - BootCamp DevOps](Days/day26.md)
- [✔️] ☁️ 27 > [-  Clase de Docker en profundidadDesafíos semanales - Windows - Analisis de Procesos en Memoria Virtual con VMMAP y en RAM (Monitoreo)](Days/day27.md)
- [✔️] ☁️ 28 > [-  Clase de Docker en profundidadDesafíos semanales - Windows - Analisis de Procesos  , Registro con ProcMon](Days/day28.md)
